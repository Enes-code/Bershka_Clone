...
import { _ as _export_sfc, a as useRoute, d as defineStore, u as useNuxtApp } from './server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(p)) {
        ...
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "wrap" }, _attrs))} data-v-df2f0852>\xDCr\xFCn bulunamad\u0131.</div>`);
      }
    };
  }
});
...
//# sourceMappingURL=_id_-BMs8p-xe.mjs.map
